...
package com.carbon.fibers.services;
...
public class BootCompleteReceiver extends BroadcastReceiver {
    ...
    private static final String ABOUT_INTENT = "com.carbon.fibers.activities.FibersActivity";
    private static final String TAG = "AboutBootReceiver";

    @Override
    public void onReceive(Context context, Intent intent) {
        /**FibersActivity aboutActivity = new FibersActivity();
